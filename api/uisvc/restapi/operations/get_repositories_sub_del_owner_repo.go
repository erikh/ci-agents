...
func GetRepositoriesSubDelOwnerRepo(h *handlers.H, ctx *gin.Context, processingHandler handlers.HandlerFunc) *errors.Error {
	...
	if err := GetRepositoriesSubDelOwnerRepoValidateURLParams(h, ctx); err != nil {
		return errors.New(err)
	}

	if processingHandler == nil {
		return errors.New("'/repositories/sub/del/{owner}/{repo}': no processor defined")
	}
	...
	return GetRepositoriesSubDelOwnerRepoResponse(h, ctx, resp, code, err)
}

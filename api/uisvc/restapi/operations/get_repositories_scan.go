...
func GetRepositoriesScan(h *handlers.H, ctx *gin.Context, processingHandler handlers.HandlerFunc) *errors.Error {
	...
	if err := GetRepositoriesScanValidateURLParams(h, ctx); err != nil {
		return errors.New(err)
	}

	if processingHandler == nil {
		return errors.New("'/repositories/scan': no processor defined")
	}
	...
	return GetRepositoriesScanResponse(h, ctx, resp, code, err)
}

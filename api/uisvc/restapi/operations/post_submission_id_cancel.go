...
func PostSubmissionIDCancel(h *handlers.H, ctx *gin.Context, processingHandler handlers.HandlerFunc) *errors.Error {
	...
	if err := PostSubmissionIDCancelValidateURLParams(h, ctx); err != nil {
		return errors.New(err)
	}

	if processingHandler == nil {
		return errors.New("'/submission/{id}/cancel': no processor defined")
	}
	...
	return PostSubmissionIDCancelResponse(h, ctx, resp, code, err)
}

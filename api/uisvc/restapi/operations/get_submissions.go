...
func GetSubmissions(h *handlers.H, ctx *gin.Context, processingHandler handlers.HandlerFunc) *errors.Error {
	...
	if err := GetSubmissionsValidateURLParams(h, ctx); err != nil {
		return errors.New(err)
	}

	if processingHandler == nil {
		return errors.New("'/submissions': no processor defined")
	}
	...
	return GetSubmissionsResponse(h, ctx, resp, code, err)
}
